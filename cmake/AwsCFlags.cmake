...
function(aws_set_common_properties target)
    ...
    target_compile_options(${target} PRIVATE ${AWS_C_FLAGS} PUBLIC ${AWS_C_DEFINES_PUBLIC})
    target_compile_definitions(${target} PRIVATE ${AWS_C_DEFINES} PUBLIC ${AWS_C_DEFINES_PUBLIC})
